...
const MasterLayout = (props) => {
    ...
    const {searchKeyword,setSearchKeyword} = productListStore()
    ...
    return (
        <Fragment>
            <Navbar  className="fixed-top px-0 shadow-sm ">
                <Container fluid={true}>
                    <Navbar.Brand>
                        ...
                        <img className="nav-logo mx-2 mb-1" src={logo} alt="logo"/>
                    </Navbar.Brand>
                    <div>
            ...
            <div ref={(div) => {
                ...
                <NavLink
                    className={(navData) => navData.isActive ? "side-bar-item-active side-bar-item mt-5" : "side-bar-item mt-2"}
                    to="/" end>
